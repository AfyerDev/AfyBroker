...
public class ProcessorManager {
    ...
    private final ConcurrentHashMap<CommandCode, RemotingProcessor<?>> cmd2processors = new ConcurrentHashMap<CommandCode, RemotingProcessor<?>>(
            4);
    ...
    private final int minPoolSize = ConfigManager
            .default_tp_min_size();

    private final int maxPoolSize = ConfigManager
            .default_tp_max_size();

    private final int queueSize = ConfigManager
            .default_tp_queue_size();

    private final long keepAliveTime = ConfigManager
