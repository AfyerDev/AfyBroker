...
public class RpcServer extends AbstractRemotingServer {
     ...
     */
    private final ConcurrentHashMap<String, UserProcessor<?>> userProcessors = new ConcurrentHashMap<String, UserProcessor<?>>(
            4);
     ...
     * rpc codec
     */
    private final Codec codec = new RpcCodec();
    ...
    private void initWriteBufferWaterMark() {
        ...
        int lowWaterMark = this.option(BoltServerOption.NETTY_BUFFER_LOW_WATER_MARK);
        int highWaterMark = this.option(BoltServerOption.NETTY_BUFFER_HIGH_WATER_MARK);
